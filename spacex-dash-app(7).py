...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Use all rows in the dataframe to render a pie chart
        fig = px.pie(
            spacex_df, 
            values='class', 
            names='Launch Site', 
        ...
        # Group by 'class' to get counts for success (1) and failure (0)
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        # Filter for the selected site and render scatter plot
